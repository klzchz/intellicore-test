...
//
//        $manager->rateCompany(5, 1);
//
//
//        $this->assertDatabaseCount('ratings', 1);
//        $this->assertEquals(5, $company->rating);
//        $manager->rateCompany(1, 2);
//    }
//
...
//        $manager = new CompanyManager($company);
//
//        $manager->rateCompany(1, 1);
//        $manager->rateCompany(1, 2);
//        $manager->rateCompany(1, 3);
//        $manager->rateCompany(2, 4);
//        $manager->rateCompany(5, 5);
//
//        $company->refresh();
//
//        $this->assertDatabaseCount('ratings', 5);
//        $this->assertEquals(2, $company->rating_average);
//        $this->assertEquals(5, $company->rating_count);
//    }
